...
import com.igurus.v02.screens.BlockPermanentScreen
import com.igurus.v02.timelimit.Screens.*
...
fun MainScreen() {
    ...
    NavHost(
        ...
        composable("block_bedtime/{packageName}/{appName}") { backStackEntry ->
            val packageName = Uri.decode(backStackEntry.arguments?.getString("packageName") ?: "")
            val appName = Uri.decode(backStackEntry.arguments?.getString("appName") ?: "")
            BlockBedtimeScreen(
                navController = navController,
